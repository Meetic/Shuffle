...
public class TestInnerScrollAdapter extends Shuffle.Adapter<Shuffle.ViewHolder> {

    @Override
    public Shuffle.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.bal_tmp_cell_inner_scroll, viewGroup, false);
